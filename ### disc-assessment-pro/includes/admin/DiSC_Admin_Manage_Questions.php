...
class DiSC_Admin_Manage_Questions extends DiSC_Admin_Base {
    ...
    public function display_questions_page() {
        ...
        // Handle the custom action for creating, editing, or viewing questions
        if (isset($_GET['action'])) {
            ...
            if ($_GET['action'] === 'create_new_question') {
                ...
                return;
            } elseif ($_GET['action'] === 'view' && isset($_GET['question_id'])) {
                $create_question->view_question(); // Call the view method to display the question
                return;
            }
        }
                    ...
                    <?php if (!empty($questions)): ?>
                        <?php foreach ($questions as $question): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo admin_url('admin.php?page=disc_manage_questions&test_id=' . $test_id . '&action=view&question_id=' . $question->question_id); ?>" class="button">View</a>
